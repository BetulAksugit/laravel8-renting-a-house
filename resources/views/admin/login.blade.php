...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets') }}/admin/css/authentication.css">
...
<div class="page-header">
    <div class="page-header-image" style="background-image:url({{ asset('assets') }}/admin/images/login.jpg)"></div>
    <div class="container">
        <div class="col-md-12 content-center">
            <div class="card-plain">
                <form class="form" action="{{ route('admin_logincheck') }}" method="post">
                    @csrf
                    <div class="header">
                        <div class="logo-container">
                            <img src="{{ asset('assets') }}/admin/images/logo.svg" alt="">
                        </div>
                        <h5>Log in</h5>
                    </div>
                    <div class="content">
