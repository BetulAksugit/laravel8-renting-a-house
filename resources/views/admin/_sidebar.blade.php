            ...
            <li>
                <div class="user-info">
                    ...
                    <div class="image"><a href="profile.html">
                            ...
                            <img
                                src="{{Storage::url(Auth::user()->profile_photo_path)}}" alt="User"></a>
                    ...
                    <div class="detail">
                        @auth
                            ...
                            <a href="{{route('admin_logout')}}" title="Sign out"><i class="zmdi zmdi-power"></i></a>
                        @endauth
                    </div>

            </li>
            <li class="header">MAIN</li>
            <li class="active open"><a href="{{route('admin_home')}}"><i class="zmdi zmdi-home"></i><span>Anasayfa</span></a></li>
            <li><a href="{{route('admin_category')}}"><i class="zmdi zmdi-pin"></i><span>Kategoriler</span></a></li>
            <li><a href="{{route('admin_houses')}}"><i class="zmdi zmdi-file-text"></i><span>İlanlar</span></a></li>
            <li><a href="{{route('admin_message')}}"><i class="zmdi zmdi-file-text"></i><span>Mesajlar</span></a></li>
            <li><a href="{{route('admin_setting')}}"><i class="zmdi zmdi-file-text"></i><span>Ayarlar</span></a></li>
            <li><a href="{{route('admin_users')}}"><i class="zmdi zmdi-file-text"></i><span>Kullanıcılar</span></a></li>
            <li><a href="{{route('admin_faq')}}"><i class="zmdi zmdi-file-text"></i><span>SSS</span></a></li>
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('assets') }}/admin//xs/avatar2.jpg" alt="">
                                    <div class="media-body">
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('assets') }}/admin/images/xs/avatar10.jpg"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('assets') }}/admin/images/xs/avatar6.jpg"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('assets') }}/admin/images/xs/avatar7.jpg"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('assets') }}/admin/images/xs/avatar8.jpg"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('assets') }}/admin/images/xs/avatar9.jpg"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
