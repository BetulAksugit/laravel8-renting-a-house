...
<nav class="navbar">
    <div class="col-12">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="{{ asset('assets') }}/admin/images/logo.svg" width="30" alt="Compass"><span class="m-l-10">Estate</span></a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="{{route('admin_logout')}}" class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a></li>
